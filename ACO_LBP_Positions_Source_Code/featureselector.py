...
from ACO_LBP_Positions_Source_Code.ant import Ant
...
class FeatureSelector:
    ...
    def heuristicCost(self, index_ant, num_feature):
        ...
        new_lr_classifier = KNeighborsClassifier(n_neighbors=3,metric="cosine")
    ...
    def antBuildSubset(self, index_ant):
        ...
        while run:
            ...
            actual_lr_classifier = KNeighborsClassifier(n_neighbors=3,metric="cosine")
